...
# def main():
#     topics = TopicSegmentation("sample_1.txt", 0.4, True)
#     # topics.create_utterances()
#     # topics.create_sentence_embeddings()
#     # topics.compute_cosine_scores()
#     # topics.inference_topics()
#     print(topics)
#
#
